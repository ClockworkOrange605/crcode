...
const save = async (root, file, content) => {
  const fd = fs.openSync(path.join(root, file), 'w')
...
export { save, upload, createFile, createFolder, copyFolder, listFolder, rename, remove }